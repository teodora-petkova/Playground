...
#image_path = 'D:\\Repositories\\Git-mine\\KNN\\kNN\\data\\train\\beach\\image2.jpg'
image_path = 'D:\\Repositories\\Git-mine\\KNN\\kNN\\data\\samples\\star.jpg'
...
hsv_features = get_hsv_features(hsvimage, window_size)
...
ehd_features = get_edge_histogram_descriptor(grayimage, window_size)
...
sobel_features = get_sobel_features(grayimage, window_size, bins_number)
